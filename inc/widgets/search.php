...
class Listdo_Search extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'listdo'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'listdo' ), )
        );
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Listdo_Search');
}