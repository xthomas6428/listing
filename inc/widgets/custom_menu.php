...
class Listdo_Custom_Menu extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_custom_menu',
            esc_html__('Apus Custom Menu Widget', 'listdo'),
            array( 'description' => esc_html__( 'Show custom menu', 'listdo' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>">
                <?php echo esc_html__('Menu:', 'listdo' ); ?>
            </label>
            <br>
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Listdo_Custom_Menu');
}