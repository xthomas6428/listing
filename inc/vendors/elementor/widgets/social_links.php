...
class Listdo_Elementor_Social_Links extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Social Links', 'listdo' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'border', // We know this mistake - TODO: 'icon_border' (for hover control condition also)
                'selector' => '{{WRAPPER}} li a',
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} li a' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_tabs( 'tabs_social_style' );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} li a' => 'background-color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} li a:hover, {{WRAPPER}} li a:focus' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} li a:hover, {{WRAPPER}} li a:focus' => 'background-color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} li a:hover, {{WRAPPER}} li a:focus' => 'border-color: {{VALUE}};',
                    ],
                ]
            );
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Listdo_Elementor_Social_Links );
} else {
    Plugin::instance()->widgets_manager->register( new Listdo_Elementor_Social_Links );
}