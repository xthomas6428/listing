...
if ( !class_exists("Listdo_Nav_Menu") ) {
    class Listdo_Nav_Menu extends Walker_Nav_Menu {
       ...
       /**
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            $item_output .= $args->has_children || $apus_mega_profile ? ' <b class="ti-angle-down"></b></a>' : '</a>';
