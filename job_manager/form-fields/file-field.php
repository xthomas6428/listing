...
?>
<div class="job-manager-uploaded-files <?php echo esc_attr( !empty($field['multiple']) ? 'multi-image' : ''); ?>">
...
<small class="description">
	...
	<?php else : ?>
		<?php printf( esc_html__( 'Maximum file size: %s.', 'listdo' ), size_format( wp_max_upload_size() ) ); ?>
	<?php endif; ?>
</small>