...
<nav class="job-manager-pagination">
	<ul>
		<?php if ( $current_page && $current_page > 1 ) : ?>
			<li><a class="prev" href="#" data-page="<?php echo esc_attr( $current_page - 1 ); ?>"><i class="fas fa-long-arrow-alt-left"></i><?php echo esc_html__('Prev','listdo') ?></a></li>
		<?php endif; ?>
		...
		<?php if ( $current_page && $current_page < $max_num_pages ) : ?>
			<li><a class="next" href="#" data-page="<?php echo esc_attr( $current_page + 1 ); ?>"><?php echo esc_html__('Next','listdo') ?><i class="fas fa-long-arrow-alt-right"></i></a></li>
		<?php endif; ?>
	</ul>
</nav>